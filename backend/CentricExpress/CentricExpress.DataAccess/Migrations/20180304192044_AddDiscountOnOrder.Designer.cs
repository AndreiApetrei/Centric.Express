...
namespace CentricExpress.DataAccess.Migrations
{
    ...
    [Migration("20180304192044_AddDiscountOnOrder")]
    partial class AddDiscountOnOrder
    {
            ...
            modelBuilder.Entity("CentricExpress.Business.Domain.Order", b =>
                {
                    ...
                    b.OwnsOne("CentricExpress.Business.Domain.Money", "Discount", b1 =>
                        {
                            ...
                            b1.HasOne("CentricExpress.Business.Domain.Order")
                                .WithOne("Discount")
                                .HasForeignKey("CentricExpress.Business.Domain.Money", "OrderId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
